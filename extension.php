...
return [
  ...
  */
  ...
  'providers' => [
    'Sanatorium\Wishlist\Providers\WishlistServiceProvider'
  ],
  ...
  */
  ...
  {
    $wishlist_routes = function()
    {
      Route::get('/', ['as' => 'sanatorium.wishlist.wishlist.index', 'uses' => 'WishlistController@index']);

      Route::any('/add', ['as' => 'sanatorium.wishlist.wishlist.add', 'uses' => 'WishlistController@add']);

      Route::get('/clear', ['as' => 'sanatorium.wishlist.wishlist.clear', 'uses' => 'WishlistController@clear']);
    };

    Route::group([
      'prefix'    => 'wishlist',
      'namespace' => 'Sanatorium\Wishlist\Controllers\Frontend',
    ], $wishlist_routes);

    Route::group([
      'prefix'    => trans('sanatorium/wishlist::wishlist.url'),
      'namespace' => 'Sanatorium\Wishlist\Controllers\Frontend',
    ], $wishlist_routes);
  },
  ...
  */
  ...
  'menus' => [
    ...
    'admin' => [
      ...
      /*[
        'slug'  => 'admin-sanatorium-wishlist',
        'name'  => 'Wishlist',
        'class' => 'fa fa-circle-o',
        'uri'   => 'wishlist',
        'regex' => '/:admin\/wishlist/i',
      ],*/
